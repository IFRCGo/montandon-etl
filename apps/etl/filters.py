...
from apps.etl.enums import DataStatusTypeEnum, PyStacLoadDataItemTypeEnum, PyStacLoadDataStatusEnum, SourceTypeEnum
...
class PystacDataFilter:
    created_at: strawberry.auto
    status: Optional[PyStacLoadDataStatusEnum]
    trace_id: strawberry.auto
