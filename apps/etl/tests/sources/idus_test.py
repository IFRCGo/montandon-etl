...
TEST_CASES = [
    {
        ...
        "expected": "fixed_output_idus.json",
    },
]
...
def test_handle_extraction_various_idu_files(case):
    ...
    input_path = settings.BASE_DIR / "apps/etl/tests/dataset/idmc_idus" / input_filename
    ...
    expected_output_path = settings.BASE_DIR / "apps/etl/tests/dataset/idmc_idus" / fixed_filename
...
||||||| parent of 77ad767 (Added items in ignored list)
    ignored_keys = {"created_at", "modified_at", "monty:etl_id","pk"}
=======
    ignored_keys = {"created_at", "modified_at", "monty:etl_id", "pk"}
>>>>>>> 77ad767 (Added items in ignored list)
