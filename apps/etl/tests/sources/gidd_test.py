...
TEST_CASES = [
    {
        "input": "gidd.json5",
        "output": "output_gidd.json",  # only used in logs
        "expected": "fixed_output_gidd.json",
    },
]
...
def test_handle_extraction_various_gidd_files(case):
    ...
    input_path = settings.BASE_DIR / "apps/etl/tests/dataset/idmc_gidd" / input_filename
    ...
    source_url = f"{etl_config.IDMC_DATA_URL}/external-api/gidd/disaggregations/disaggregation-geojson/"
