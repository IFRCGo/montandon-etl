...
from apps.etl.extraction.sources.alert_hub.extract import AlertHubExtraction
...
source_extraction_map = {
    ...
    ExtractionData.Source.ALERTHUB: AlertHubExtraction,
}
source_transform_map = {
    ...
    ExtractionData.Source.ALERTHUB: AlertHubTransformHandler,
}
