...
def import_hazard_data(self, hazard_type: str, hazard_type_str: str, **kwargs):
    ...
    glide_url = f"https://www.glidenumber.net/glide/jsonglideset.jsp?fromyear=2024&frommonth=01&fromday=01&toyear=2025&frommonth=12&to_date=31&events={hazard_type}"  # noqa: E501
