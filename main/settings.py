...
env = environ.Env(
    ...
    COPERNICUS_URL=(str, "https://rapidmapping.emergency.copernicus.eu"),
    ...
    COPERNICUS_TRANSFORMER_VERSION=(str, "1.0.0"),
)
...
COPERNICUS_URL = env("COPERNICUS_URL")
...
COPERNICUS_TRANSFORMER_VERSION = (env("COPERNICUS_TRANSFORMER_VERSION"),)
