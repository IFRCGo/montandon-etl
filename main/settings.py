...
env = environ.Env(
    ...
    CHARTER_S3_ENDPOINT_URL=(str, None),
    CHARTER_S3_ACCESS_KEY_ID=(str, None),
    CHARTER_S3_SECRET_ACCESS_KEY=(str, None),
    CHARTER_S3_BUCKET_NAME=(str, "cpe-operations-catalog"),
    ...
    CEMS_URL=(str, "https://rapidmapping.emergency.copernicus.eu"),
    ...
    CEMS_TRANSFORMER_VERSION=(str, "1.0.0"),
    CHARTER_TRANSFORMER_VERSION=(str, "1.0.0"),
)
...
CHARTER_S3_ENDPOINT_URL = env("CHARTER_S3_ENDPOINT_URL")
CHARTER_S3_ACCESS_KEY_ID = env("CHARTER_S3_ACCESS_KEY_ID")
CHARTER_S3_SECRET_ACCESS_KEY = env("CHARTER_S3_SECRET_ACCESS_KEY")
CHARTER_S3_BUCKET_NAME = env("CHARTER_S3_BUCKET_NAME")
...
CEMS_TRANSFORMER_VERSION = (env("CEMS_TRANSFORMER_VERSION"),)
CHARTER_TRANSFORMER_VERSION = env("CHARTER_TRANSFORMER_VERSION")
